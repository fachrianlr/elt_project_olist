...
def load_data(file_mapping):
    ...
    try:
        query_path = os.path.join(PARENT_FOLDER, "resources", "sql", "load.xml")
        ...
        extract_folder = os.path.join(PARENT_FOLDER, "resources", "extract")
        load_folder = os.path.join(PARENT_FOLDER, "resources", "load")
