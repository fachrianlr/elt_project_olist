...
class ExtractTask(luigi.Task):
    ...
    def output(self):
        ...
        return {csv_name: luigi.LocalTarget(os.path.join(PARENT_FOLDER, "resources", "extract", csv_name)) for _, csv_name in
...
class LoadTask(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget(os.path.join(PARENT_FOLDER, "resources", "load", "status.csv"))
...
class TransformTask(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget(os.path.join(PARENT_FOLDER, "resources", "transform", "status.csv"))
